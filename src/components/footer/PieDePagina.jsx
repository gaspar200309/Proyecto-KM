        ...
        <>
            <div className="pie-pagina ">
                <div className="contenedor-piepagina contenedor">
                    <div className="info">
                        <h3>Dirección</h3>
                        <p>C. Luis Castell N° 1900. <br />Frente al parque Teleferico-CBBA</p>
                    </div>
                    <div className="info">
                        <h3>Menu</h3>
                        <Link to="/">Inicio</Link>
            ...
            <footer className="footer">
                ...
                <p>Todos los derechos reservados <span className="fecha"></span> &copy; Desarrollo por gaspar123</p>
            </footer>
        </>
    )
}
